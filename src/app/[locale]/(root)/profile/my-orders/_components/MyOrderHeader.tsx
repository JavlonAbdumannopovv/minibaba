const MyOrderHeader = () => {
  return (
    <div className="items-center justify-between lg:flex">
      ...
      <div className="mt-4 flex items-center justify-start gap-2 lg:mt-0 lg:justify-center">
        <div className="flex h-17.5 max-w-42.5 min-w-30 flex-col items-start justify-center rounded-[8px] border border-[#F47B251A] bg-white p-3">
          <div className="text-[12px] text-[#64748B]">Jami xarajat</div>
          <div className="text-[16px] font-bold text-[#F47B25]">14,250,000 UZS</div>
        </div>
        <div className="flex h-17.5 w-37.25 min-w-30 flex-col items-start justify-center rounded-[8px] border border-[#F47B251A] bg-white p-3">
