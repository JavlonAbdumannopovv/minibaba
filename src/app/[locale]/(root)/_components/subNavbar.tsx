...
const SubNavbar = () => {
  ...
  return (
    <>
      <div className="mobil md:hidden flex  relative top-0 z-35 items-center justify-center md:border-b border-gray-200 bg-white">
        ...
        <div
          className={`no-scrollbar absolute top-[49px] left-0 w-full overflow-y-auto bg-white shadow-xl transition-all duration-300 ease-in-out ${isOpen ? "max-h-180 border-t border-gray-100" : "max-h-0"
            }`}
        >
          <div className="mx-auto md:flex min-h-[500px] max-w-7xl bg-white px-3">
            <div className="flex md:w-70  flex-col md:border-r border-gray-100 bg-white">
                ...
                >
                  {categories.map((cat) => (
                    <AccordionItem key={cat.id} value={cat.slug} className="border-0 ">
                      <AccordionTrigger className="bg" >
                        <div
                          key={cat.id}
                          onClick={() => setActiveTab(cat.id)}
                          className={`flex w-full cursor-pointer items-center justify-between px-6 py-3 transition-colors ${activeTab === cat.id
                      ...
                      <AccordionContent>
                        <div className="flex-1 bg-white md:p-8 p-2">
                          <div className="mb-4">
      ...
      <div className="desktop md:flex hidden relative top-0 z-35  items-center justify-center md:border-b border-gray-200 bg-white">
        <div className="flex h-[49px] w-full max-w-7xl items-center justify-between px-3">
          <div className="flex h-full justify-start">
            <div
              onClick={() => setIsOpen(!isOpen)}
