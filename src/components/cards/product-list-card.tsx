    ...
    <Link href={`${segments[2]}/${product.id}`}>
      <div className="group bg-card flex cursor-pointer flex-col overflow-hidden rounded-xl shadow-sm transition-all duration-300 hover:shadow-xl">
        ...
        <div className="bg-muted relative aspect-square overflow-hidden">
          ...
          <button
            type="button"
            className="bg-bg text-foreground hover:bg-primary hover:text-text-inverse absolute top-3 right-3 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full shadow-sm transition-colors"
          >
